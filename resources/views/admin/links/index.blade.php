...
@section('content')
        ...
        <div class="result_wrap">
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        <td class="tc">
                            <input type="text" onchange="changeOrder(this,{{$v->link_id}})" value="{{$v->link_order}}">  {{--传入input这个对象及link_id--}}
                        </td>
    ...
    <script>
        function changeOrder(obj,link_id) {
            var link_order=$(obj).val();    // 获取对象input输入的link_order值
            // 调用方法，传入token、link_id及link_order值，通过回调函数获取$data的值
        ...
        function delLink(link_id) {
            layer.confirm('您确定要删除此分类吗？', {
                ...
                $.post("{{url('admin/links')}}/"+link_id,{'_method':'delete','_token':'{{csrf_token()}}'},function (datas) {
