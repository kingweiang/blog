...
@section('content')
        ...
        <div class="result_wrap">
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        <td class="tc">
                            <input type="text" onchange="changeOrder(this,{{$v->nav_id}})" value="{{$v->nav_order}}">  {{--传入input这个对象及nav_id--}}
                        </td>
    ...
    <script>
        function changeOrder(obj,nav_id) {
            var nav_order=$(obj).val();    // 获取对象input输入的nav_order值
            // 调用方法，传入token、nav_id及nav_order值，通过回调函数获取$data的值
        ...
        function delLink(nav_id) {
            layer.confirm('您确定要删除此分类吗？', {
                ...
                $.post("{{url('admin/navs')}}/"+nav_id,{'_method':'delete','_token':'{{csrf_token()}}'},function (datas) {
