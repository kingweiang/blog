    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>PHP运行方式</label><span><?php echo @get_cfg_var("mysql.allow_persistent")?"是 ":"否"; ?> </span>
                </li>
                <li>
                    <label>MySQL最大链接数</label><span><?php echo @get_cfg_var("mysql.max_links")==-1 ? "不限" : @get_cfg_var("mysql.max_links");?></span>
                </li>
                <li>
