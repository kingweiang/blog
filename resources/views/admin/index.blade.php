...
@section('content')
	...
	<div class="menu_box">
		<ul>
            <li>
            	<h3><i class="fa fa-fw fa-clipboard"></i>内容设置</h3>
                <ul class="sub_menu">
            ...
            <li>
               ...
               <ul class="sub_menu" style="display: block">   {{-- style="display: block" 是展开显示--}}
                    ...
                    <li><a href="#" ><i class="fa fa-fw fa-database"></i>备份还原</a></li>
                </ul>
            </li>
            <li>
